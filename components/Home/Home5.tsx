        ...
        <div className="flex flex-col h-auto py-[50px] bg-color5">
            ...
            <div className="flex flex-col md:flex-row justify-around px-5 md:px-10 lg:px-20 items-center font-bold">
                <div className="flex flex-col gap-2 text-center md:text-left">
                    <Image src={img9} alt="Material Innovation" width={300} height={300} className="mx-auto md:mx-0" />
                    <h1 className="text-xl md:text-2xl">MATERIAL INNOVATION</h1>
                ...
                <div className="flex flex-col gap-2 text-center md:text-left">
                    <Image src={img10} alt="Circularity" width={300} height={300} className="mx-auto md:mx-0" />
                    <h1 className="text-xl md:text-2xl">CIRCULARITY</h1>
                    <p className="px-5 md:px-0">
                ...
                <div className="flex flex-col gap-2 text-center md:text-left">
                    <Image src={img11} alt="Collective Activism" width={300} height={300} className="mx-auto md:mx-0" />
                    <h1 className="text-xl md:text-2xl">COLLECTIVE ACTIVISM</h1>
                    <p className="px-5 md:px-0">
